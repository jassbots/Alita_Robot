...
const (
	...
	startHelp = "Hey there! My name is Yo HelpboT✨.\n" +
		"I'm here to help you manage your groups!\n" +
		"Hit /help to find out more about how to use me to my full potential.\n" +
		"Join my <a href='https://t.me/entity_unavailable'>News Channel</a> to get information on all the latest updates."
	mainhlp = "Hey %s!\n" +
		"My name is Yo HelpboT ✨.\n\n" +
	...
	aboutKb = gotgbot.InlineKeyboardMarkup{
		InlineKeyboard: [][]gotgbot.InlineKeyboardButton{
			...
			},
			{
				{
					Text: "News Channel 📢",
					Url:  "https://t.me/entity_unavailable",
				},
				{
					Text: "Support Group 👥",
